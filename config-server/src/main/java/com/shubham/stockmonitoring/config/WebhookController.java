...
public class WebhookController {
    ...
    @Value("${services.master-data-service.url:http://localhost:8083}")
    ...
    public ResponseEntity<Map<String, Object>> handleGitHubWebhook(
        ...
        refreshService("profile-service", profileServiceUrl, results);
        refreshService("master-data-service", masterDataServiceUrl, results);
    ...
    private void refreshService(String serviceName, String serviceUrl, Map<String, Object> results) {
        try {
            ...
            if ("auth-service".equals(serviceName)) {
                actuatorPath = "/v1/api/actuator/refresh";
            }
